    ...
    <body>
        <div class="table-responsive">          
            <table class="table">
                ...
                <% FileData ficherosData = (FileData) request.getAttribute("ficherosCuarentena");
                    for (int i = 0; i < ficherosData.ficheros.size(); i++) {%>
                <tbody>
                    <tr>
                        <td><li><%=ficherosData.ficheros.get(i)%></li></td>
                        <td><button class="btn btn-primary" onclick="download('<%=ficherosData.smbPath.get(i)%>')" class="btn btn-warning"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></button></td>
            ...
            <button id="clean" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Limpiar Cuarentena </button>
    </body>
</html>
